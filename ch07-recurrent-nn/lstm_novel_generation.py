...
novel_model = torch.load('novel_model', weights_only=False)
vocab_word2index = torch.load('vocab_word2index', weights_only=False)
vocab_index2word = torch.load('vocab_index2word', weights_only=False)
novel_model.eval()
